...
def create_file(filename):
    ...
    HTML_FILE = filename[8:len(filename)-1] + ".html" #Magic number 8: 7 caracteres son los que hay que quitar al principio del string [filaname] == "STRING:"filename""
...
def add(tag, id, path):
        ...
        contents = get_file_contents(HTML_FILE)
        ...
        write_in_file(HTML_FILE,contents)
